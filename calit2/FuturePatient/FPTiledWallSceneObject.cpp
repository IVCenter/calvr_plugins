...
FPTiledWallSceneObject::FPTiledWallSceneObject(std::string name, bool navigation, bool movable, bool clip,
...
FPTiledWallSceneObject::~FPTiledWallSceneObject()
{
}

void FPTiledWallSceneObject::setTiledWallMovement(bool b)
{
...
void FPTiledWallSceneObject::moveCleanup()
{
    if(!_tiledWallMovement)
    {
