#ifndef FP_GROUPED_BAR_GRAPH_W_POINTS_H
#define FP_GROUPED_BAR_GRAPH_W_POINTS_H
...
class GroupedBarGraphWPoints
{
    public:
        GroupedBarGraphWPoints(float width, float height);
        virtual ~GroupedBarGraphWPoints();

        bool setGraph(std::string title, std::map<std::string, std::vector<std::pair<std::string, float> > > & data, std::vector<std::string> & groupOrder, std::map<std::string,std::map<std::string,std::map<std::string,std::vector<std::pair<std::string,float> > > > > & otherPointData, BarGraphAxisType axisType, std::string axisLabel, std::string axisUnits, std::string groupLabel, osg::Vec4 color);
        ...
        void setPointColorMapping(const std::map<std::string,osg::Vec4> & colorMap);
    ...
    protected:
        ...
        std::map<std::string,std::map<std::string,std::map<std::string,std::vector<std::pair<std::string,float> > > > > _pointData;
