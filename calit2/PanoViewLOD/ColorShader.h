...
"    t = (gl_Vertex.xy - tex_a[level]) / (tex_d[level] - tex_a[level]); \n"
"    vec2 t0 =  tex_a[0]                          \n"
"           + (tex_d[0] - tex_a[0]) * gl_Vertex.xy; \n"
"                                                    \n"
"    vec3 v = bislerp(pos_a, pos_b, pos_c, pos_d, t0);\n"
"                                                    \n"
"    gl_TexCoord[0].xy = t;                          \n"
"                                                    \n"
...
"void main()                                         \n"
"{                                                   \n"
"    vec3 p = texture2D(image[level], gl_TexCoord[0].xy).rgb; \n"
