...
typedef double Vector3[3];  ///< Vector3 is a double array of size 3

typedef Vector3 Vector3x8[8];   ///<Vector3 is an array of 8 Vector3 objects
...
typedef double Matrix4x4[16];   ///<4x4 matrix
