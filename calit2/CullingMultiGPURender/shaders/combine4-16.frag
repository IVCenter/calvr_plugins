...
void main()
{
    ...
    float temp = 1.0 - (float(texture2DRect(depth[1],gl_FragCoord.xy).r) / 65535.0);
    ...
    temp = 1.0 - (float(texture2DRect(depth[2],gl_FragCoord.xy).r) / 65535.0);
    ...
    temp = 1.0 - (float(texture2DRect(depth[3],gl_FragCoord.xy).r) / 65535.0);
