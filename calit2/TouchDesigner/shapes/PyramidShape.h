...
public:        
	...
	PyramidShape(string, Vec3d&, Vec3d&, Vec3d&, Vec4d&, Vec4d&, Vec4d&);

	// name, p1, p2, p3, color1, color2
	PyramidShape(string, Vec3d&, Vec3d&, Vec3d&, Vec4d&, Vec4d&);

	// name, p1, p2, p3, color
	PyramidShape(string, Vec3d&, Vec3d&, Vec3d&, Vec4d&);
	
	// name, p1, p2, p3
	PyramidShape(string, Vec3d&, Vec3d&, Vec3d&);

	// name, center, length, color
	// this generates a solid color equalateral triangle with center point _center
	PyramidShape(string, Vec3d&, int, Vec4d&);

	// name, center, length, color, gradient
	// this generates a vertical gradient equalateral triangle with center point _center
	PyramidShape(string, Vec3d&, int, Vec4d&, Vec4d&);

	// name, center, length
	PyramidShape(string, Vec3d&, int);
