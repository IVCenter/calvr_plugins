...
class MultiGPUDrawable : public osg::Drawable
{
    public:
        ...
        void cudaLoadNextVBOs(int context, cudaStream_t & stream);
    protected:
        ...
        void cudaCleanup(int context) const;
        ...
        mutable std::map<int,GLuint> _depthR8BufferMap;
        ...
        mutable std::map<int,GLuint> _drawGeoShaderMap;
        mutable std::map<int,GLuint> _drawGeoProgMap;
