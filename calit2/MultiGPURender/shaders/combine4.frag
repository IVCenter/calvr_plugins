...
void main()
{
    ...
    float dpth = 1.0 - ((texture2DRect(depth[0],gl_FragCoord.xy).r * 16776960 + texture2DRect(depthR8[0],gl_FragCoord.xy).r * 255) / 16777215.0);
    float temp = 1.0 - ((texture2DRect(depth[1],gl_FragCoord.xy).r * 16776960 + texture2DRect(depthR8[1],gl_FragCoord.xy).r * 255) / 16777215.0);
    ...
    temp = 1.0 - ((texture2DRect(depth[2],gl_FragCoord.xy).r * 16776960 + texture2DRect(depthR8[2],gl_FragCoord.xy).r * 255) / 16777215.0);
    if(temp < dpth)
    {
	dpth = temp;
	//gl_FragColor = texture2DRect(colors[1],gl_FragCoord.xy);
    ...
    temp = 1.0 - ((texture2DRect(depth[3],gl_FragCoord.xy).r * 16776960 + texture2DRect(depthR8[3],gl_FragCoord.xy).r * 255) / 16777215.0);
    if(temp < dpth)
    {
	dpth = temp;
	//gl_FragColor = texture2DRect(colors[1],gl_FragCoord.xy);
