...
void main()
{
    ...
    //gl_FragColor.r = 1.0 - ((texture2DRect(depth[1],gl_FragCoord.xy).r * 16776960 + texture2DRect(depthR8[2],gl_FragCoord.xy).r * 255) / 16777215.0);
    //gl_FragColor.r = texture2DRect(colors[0],gl_FragCoord.xy).r
    //return;
