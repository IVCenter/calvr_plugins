...
static string PATH_5X5 = "/home/calvr/CVRPlugins/calit2/SpatialViz/Puzzle5x5/Puzzle5x5.dae";
static string PATH_MAZE = "/home/calvr/CVRPlugins/calit2/SpatialViz/MazePuzzle/PuzzleMaze.dae";
static string PATH_MAZE_BOX = "/home/calvr/CVRPlugins/calit2/SpatialViz/MazePuzzle/MazeBox5.dae";
static string PATH_PUZZLE1 = "/home/calvr/CVRPlugins/calit2/SpatialViz/5PiecePuzzle/cube1of5.dae";
static string PATH_PUZZLE2 = "/home/calvr/CVRPlugins/calit2/SpatialViz/5PiecePuzzle/cube2of5.dae";
static string PATH_PUZZLE3 = "/home/calvr/CVRPlugins/calit2/SpatialViz/5PiecePuzzle/cube3of5.dae";
static string PATH_PUZZLE4 = "/home/calvr/CVRPlugins/calit2/SpatialViz/5PiecePuzzle/cube4of5.dae";
static string PATH_PUZZLE5 = "/home/calvr/CVRPlugins/calit2/SpatialViz/5PiecePuzzle/cube5of5.dae";
...
void SpatialViz::initPhysX()
{
    ...
    _sceneDesc->gravity=PxVec3(0.0f, 9.81f, 0.0f);            // adding gravity 
    ...
    //  -------------------- Create cube(s) --------------------
    //createBoxes(3, PxVec3(0.0f, 0.3f, 0.0f), PxVec3(0.05, 0.025, 0.05), false);

    //  -------------------- Create sphere(s) --------------------
    //createSpheres(2, PxVec3(0.7f, 0.3f, 0.0f));
    createSpheres(1, PxVec3(0.125, -0.245, 0.19), 0.0075);
...
void SpatialViz::preFrame()
{
    if( currTime < end) 
	{
        ...
        gScene->setGravity(PxVec3(gravity[0], gravity[1], gravity[2]));
